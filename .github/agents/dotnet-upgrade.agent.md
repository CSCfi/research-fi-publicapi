...
name: '.NET Upgrade'
tools: ['search/codebase', 'edit/editFiles', 'search', 'execute/runInTerminal', 'execute/runTask', 'execute/runTests', 'read/problems', 'changes', 'search/usages', 'findTestFiles', 'execute/testFailure', 'read/terminalLastCommand', 'read/terminalSelection', 'web/fetch', 'microsoft.docs.mcp']
---
...
4. Generate an upgrade plan to move from current → next stable version (e.g., `net8.0 → net10.0`, or `net10.0 → net12.0`).
