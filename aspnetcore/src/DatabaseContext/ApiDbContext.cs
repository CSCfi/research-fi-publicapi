...
public partial class ApiDbContext : DbContext
{
    ...
    public virtual DbSet<DimAddress> DimAddresses { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DimAddress>(entity =>
        {
            ...
            entity.HasOne(d => d.DimContactInformation).WithMany(p => p.DimAddresses)
                .HasForeignKey(d => d.DimContactInformationId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("contactAddress");
        });
        ...
        modelBuilder.Entity<DimDescriptiveItem>(entity =>
        {
            ...
            entity.Property(e => e.Created)
                .HasColumnType("datetime")
                .HasColumnName("created");
            entity.Property(e => e.DescriptiveItem).HasColumnName("descriptive_item");
        ...
        modelBuilder.Entity<DimEmailAddrress>(entity =>
        {
            ...
            entity.HasOne(d => d.DimContactInformation).WithMany(p => p.DimEmailAddrresses)
                .HasForeignKey(d => d.DimContactInformationId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("contactByEmail");
        ...
        modelBuilder.Entity<DimEsfri>(entity =>
        {
            ...
            entity.HasMany(d => d.DimInfrastructures).WithMany(p => p.DimEsfris)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    r => r.HasOne<DimInfrastructureOld>().WithMany()
        ...
        modelBuilder.Entity<DimInfrastructure>(entity =>
        {
            ...
            entity.HasOne(d => d.DimEndDateNavigation).WithMany(p => p.DimInfrastructureDimEndDateNavigations)
                .HasForeignKey(d => d.DimEndDate)
                .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            entity.HasOne(d => d.DimStartDateNavigation).WithMany(p => p.DimInfrastructureDimStartDateNavigations)
                .HasForeignKey(d => d.DimStartDate)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("infraStartDate");

            entity.HasOne(d => d.ResponsibleOrganization).WithMany(p => p.DimInfrastructures)
                .HasForeignKey(d => d.ResponsibleOrganizationId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_dim_organization");
        });
        ...
        modelBuilder.Entity<DimService>(entity =>
        {
            ...
            entity.HasOne(d => d.EndDateNavigation).WithMany(p => p.DimServiceEndDateNavigations)
                .HasForeignKey(d => d.EndDate)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("serviceEndsOn");

            entity.HasOne(d => d.StartDateNavigation).WithMany(p => p.DimServiceStartDateNavigations)
                .HasForeignKey(d => d.StartDate)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("serviceStartsOn");
        });
        ...
        modelBuilder.Entity<DimTelephoneNumber>(entity =>
        {
            ...
            entity.HasOne(d => d.DimContactInformation).WithMany(p => p.DimTelephoneNumbers)
                .HasForeignKey(d => d.DimContactInformationId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("contactByTelephone");
        ...
        {
            entity.HasKey(e => new { e.DimKeywordId, e.DimResearchProjectId, e.DimResearchDatasetId }).HasName("PK__fact_key__3711EA3D89A5A3EE");
        ...
        modelBuilder.Entity<FactReferencedatum>(entity =>
        {
            ...
            entity.HasOne(d => d.DimService).WithMany(p => p.FactReferencedata)
                .HasForeignKey(d => d.DimServiceId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("service_referencedata");
        });
        ...
        modelBuilder.Entity<PidM>(entity =>
        {
