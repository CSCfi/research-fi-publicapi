...
public partial class ImportDbContext : DbContext
{
    ...
    public virtual DbSet<ImpLinkPublicationToGrantedFunding> ImpLinkPublicationToGrantedFundings { get; set; }

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<ImpLinkPublicationToGrantedFunding>(entity =>
        {
            entity.ToTable("imp_link_publication_to_granted_funding");
