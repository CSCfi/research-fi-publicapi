...
public class PublicationProfile : Profile
{
    ...
    public PublicationProfile()
    {
        ...
        CreateProjection<DimPublication, Publication>()
            ...
            .ForMember(dst => dst.ReportSwitch, opt => opt.MapFrom(src => src.ReportSwitchNavigation))
            .ForMember(dst => dst.AudioVisualApplicationType, opt => opt.MapFrom(src => src.AvApplicationTypeCodeNavigation))
            .ForMember(dst => dst.ArtPublicationType, opt => opt.MapFrom(src => src.ArtTypeCodeNavigation))
