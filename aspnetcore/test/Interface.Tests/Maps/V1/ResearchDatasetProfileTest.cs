...
public class ResearchDatasetProfileTest
{
    ...
    {
        _mapper = new MapperConfiguration(cfg => cfg.AddProfile<CSC.PublicApi.Interface.Maps.V1.ResearchDatasetProfile>()).CreateMapper();
    }
    ...
    public void Map_ResearchDatasetServiceModel_ReturnsApiModel()
    {
        ...
        // Act
        var result = _mapper.Map<ResearchFi.ResearchDataset.V1.ResearchDataset>(serviceModel);
    ...
    private static ResearchFi.ResearchDataset.V1.ResearchDataset GetApiModel()
    {
        return new ResearchFi.ResearchDataset.V1.ResearchDataset
        {
            NameFi = "nameFi",
            NameSv = "nameSv",
            NameEn = "nameEn",
            ...
            DescriptionEn = "descEn",
            Created = new DateTime(2021, 10, 1),
            Contributors = new List<ResearchFi.ResearchDataset.Common.Contributor>
            {
                new()
                {
                    Organization = new ResearchFi.ResearchDataset.Common.Organization
                    {
                        Id = "organizationId",
                        NameFi = "organizationNameFi",
                        NameSv = "organizationNameSv",
                    ...
                    Person = new ResearchFi.ResearchDataset.Common.Person {
                        Name = "personFullName"
                    },
                    Role = new AgentRole
                    {
            ...
            DatasetRelations = new List<ResearchFi.ResearchDataset.Common.DatasetRelation>
            {
                new()
                {
                    Id = "32410",
            ...
            ResearchDataCatalog = new ResearchFi.ResearchDataset.Common.ResearchDataCatalog
            {
                Id = 7,
                NameFi = "researchDataCatalogNameFi",
                NameSv = "researchDataCatalogNameSv",
            ...
            VersionSet = new List<ResearchFi.ResearchDataset.Common.Version>
            {
                new()
                {
                    Identifier = "45670894-2a22-422e-8858-2fe52938276d",
