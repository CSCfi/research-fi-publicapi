...
namespace CSC.PublicApi.Interface.Tests.Maps.V2;
...
public class ResearchDatasetProfileTest
{
    ...
    {
        _mapper = new MapperConfiguration(cfg => cfg.AddProfile<CSC.PublicApi.Interface.Maps.V2.ResearchDatasetProfile>()).CreateMapper();
    }
    ...
    public void Map_ResearchDatasetServiceModel_ReturnsApiModel()
    {
        ...
        // Act
        var result = _mapper.Map<ResearchFi.ResearchDataset.V2.ResearchDataset>(serviceModel);
    ...
    private static ResearchFi.ResearchDataset.V2.ResearchDataset GetApiModel()
    {
        return new ResearchFi.ResearchDataset.V2.ResearchDataset
        {
            NameFi = "nameFi",
            NameSv = "nameSv",
            NameEn = "nameEn",
